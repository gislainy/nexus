...
async function main(): Promise<void> {
  ...
  const profiles: Array<{
  ...
  }> = [
    {
      ...
      vocabulary: ["ROI", "governance", "compliance", "risk", "budget"],
      technicalDepth: "LOW",
    },
    {
      id: "ARCHITECT",
      ...
      vocabulary: ["consensus", "node", "smart contract", "latency", "throughput"],
      technicalDepth: "HIGH",
    },
    {
      id: "DEVELOPER",
      ...
      vocabulary: ["API", "SDK", "transaction", "wallet", "gas fee"],
      technicalDepth: "HIGH",
    },
    {
      id: "CLINICAL",
      ...
      vocabulary: ["EHR", "patient record", "audit trail", "consent", "FHIR"],
      technicalDepth: "LOW",
    },
    {
      id: "REGULATORY",
      ...
      vocabulary: ["LGPD", "HIPAA", "ANVISA", "data subject", "DPA", "DPIA"],
